...
const TextForm = (props) => {
    ...
    return (
        <div>
            <h1>{props.heading}</h1>
            <div className="mb-3">
            <textarea className="form-control" value={text} id="myText" rows="5" onChange={handleonChange}></textarea>
            </div>
            ...
            <input type="text" className="mx-1" placeholder="Search for a Word" onChange={(event)=> setstr(event.target.value)}/><button className="btn btn-primary mx-1" onClick={searchString}>Search</button>
